...
#define XX(num, name, string) \
    ...
    HTTP_METHOD_MAP(XX);                 //HTTP_METHOD_MAP建立map结构以及数据，对数据的操作定义为XX ---> 由使用者自己提供 ---> 提供的XX会操作所有数据
#undef XX
